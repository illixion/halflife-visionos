        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("“Hand-tracked weapon model” draws the weapon in your hand, tracking it directly (world-lit); off falls back to the classic engine-drawn weapon. “Fire aims at → Where I look” is an accessibility option: shots follow your gaze instead of the weapon barrel. “Immersive gesture input” lets you fire with a finger-gun — curl your dominant index finger to pull the trigger (pinch still fires too). Reload by curling your thumb down (index extended) and holding until the ring above the weapon fills. Move with the other hand: pinch thumb+index and drag like a joystick; raise or drop the pinched hand to jump or crouch. Switch weapons with the weapon wheel: pinch all fingertips together (🤌), move your hand toward a sector, release to pick that slot (works best with fast weapon switch on).")
                }
